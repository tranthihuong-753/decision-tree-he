...
// 2. Không sử dụng rotate_vector 

// 2 theta 2 max_depth 
// Accuracy = 86.666667%
// calculate_f1_score() - Macro Average
//  Number of Classes (L): 3, Number of Samples (N): 30
// --- F1 Score Per Class ---
// Class | Precision | Recall | F1-Score
// ------|-----------|--------|-----------
//     0 |    1.0000 | 0.900000 | 0.947368
//     1 |    0.7692 | 1.000000 | 0.869565
//     2 |    0.8750 | 0.700000 | 0.777778

// 31 theta 2 max_depth
// Accuracy = 66.666667%
// calculate_f1_score() - Macro Average
//  Number of Classes (L): 3, Number of Samples (N): 30
// --- F1 Score Per Class ---
// Class | Precision | Recall | F1-Score
// ------|-----------|--------|-----------
//     0 |    0.7500 | 0.900000 | 0.818182
//     1 |    1.0000 | 0.200000 | 0.333333
//     2 |    0.5625 | 0.900000 | 0.692308
// Loi chon nguong if(-0.2<=theta<=0.2)theta+=0.2 ??? sua thanh continue roi 
...
// Class | Precision | Recall | F1-Score
// ------|-----------|--------|-----------
//     0 |    0.9000 | 0.900000 | 0.900000
//     1 |    0.8333 | 1.000000 | 0.909091
//     2 |    0.8750 | 0.700000 | 0.777778
...
string src_model_tree = "C:/hu/decision-tree-he/model_tree/model_tree_ten.bin"; // C:\hu\decision-tree-he\Build_Project\model_tree_sevent.bin
...
struct Node_c {
    ...
    vector<Ciphertext> feature_index; // k giá trị với 1 giá trị 1, k-1 giá trị 0 
